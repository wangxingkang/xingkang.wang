...
收录通用 JavaScript / TypeScript 库与浏览器能力。服务端与系统接口见 [Node.js](/awesome/node)，框架绑定包见 [React](/awesome/react)、[Vue](/awesome/vue)、[Svelte](/awesome/svelte)和 [Solid](/awesome/solid)。
