...
- [Node Modules Inspector](https://github.com/antfu/node-modules-inspector) 可视化本地 node_modules，检查依赖关系、重复版本与安装体积
...
- [pnpm-patch-i](https://github.com/antfu/pnpm-patch-i) 更友好的交互式 pnpm patch 包装器，可在本地 node_modules 中编辑并自动提交补丁
