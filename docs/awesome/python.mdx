...
- [llama_index](https://github.com/run-llama/llama_index) 主流文档智能体与光学字符识别平台
...
- [json_repair](https://github.com/mangiucugna/json_repair) 可修复来自大语言模型、接口、日志与用户输入的格式错误 JSON
