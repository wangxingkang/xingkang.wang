...
收录通用 JavaScript / TypeScript 库与浏览器能力。服务端与系统接口见 [Node.js](/awesome/node.md)，框架绑定包见 [React](/awesome/react.md)、[Vue](/awesome/vue.md)、[Svelte](/awesome/svelte.md)和 [Solid](/awesome/solid.md)。
...
- [deepmerge-ts](https://github.com/RebeccaStevens/deepmerge-ts) 深度合并两个及以上对象，同时保留类型信息
...
- [fast-equals](https://github.com/planttheidea/fast-equals) 一款速度极快的相等性对比工具，支持浅对比与深对比
...
- [chinese-conv](https://github.com/aqzhyi/chinese-conv) 简繁中文转换工具库
- [es-hangul](https://github.com/toss/es-hangul) 用于处理韩文字符的现代 JavaScript 库
...
- [@medv/finder](https://github.com/antonmedv/finder) CSS 选择器生成器
...
- [@fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) 最先进的开源浏览器指纹库
...
- [@total-typescript/ts-reset](https://github.com/mattpocock/ts-reset) 一款面向 TypeScript 的样式重置类工具，用于优化常用 JavaScript API 的类型定义
...
- [glTF-Transform](https://github.com/donmccurdy/glTF-Transform) 面向 Web 与 Node.js 的 glTF 2.0 JavaScript/TypeScript SDK 和 CLI，用于读取、编辑、优化 3D 模型
...
- [rehype-pretty-code](https://github.com/rehype-pretty/rehype-pretty-code) 适用于 Markdown / MDX 的精美代码块组件
