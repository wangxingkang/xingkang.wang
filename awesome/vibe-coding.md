...
收录 AI 编程工具、宿主扩展、开发技能与工程工作流。通用智能体平台、模型服务和办公创作技能见 [AI](/awesome/ai.md)。
...
- [pi\_agent\_rust](https://github.com/Dicklesworthstone/pi_agent_rust) 用 Rust 编写的高性能 AI 编程智能体命令行工具，**零不安全代码**
...
- [DeepWiki](https://deepwiki.com/) 为代码仓库生成可对话的 AI 文档，用于理解项目结构与实现
...
- [ai-memory](https://github.com/akitaonrails/ai-memory) 为 AI 编码代理提供跨会话、跨机器的长期记忆与交接
...
- [superdesign](https://superdesign.dev) 页面设计
...
- [Refero Styles](https://styles.refero.design/) 收录 2,000+ 可供 AI 编码智能体使用的 DESIGN.md 设计系统示例
...
- [CodeBurn](https://github.com/getagentseal/codeburn) 本地分析 41 种 AI 编码工具的 Token 用量与成本，支持按模型、项目和任务统计
