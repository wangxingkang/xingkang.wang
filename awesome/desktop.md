...
- [ego-lite](https://github.com/citrolabs/ego-lite) 一款面向 AI 代理的高效浏览器，支持真人与多个代理并行使用同一浏览器上下文进行自动化任务
...
- [LiveContainer](https://github.com/LiveContainer/LiveContainer) 在 macOS / Windows 上运行 iOS 应用的开源容器，适用于应用测试与侧载开发调试
