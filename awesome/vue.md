...
- [vue](https://github.com/vuejs/core) vue 仓库
...
- [nuxt](https://github.com/nuxt/nuxt) 全栈 Vue 框架
- [quasar](https://github.com/quasarframework/quasar) 以空前的速度构建高性能的 VueJS 用户界面
...
- [inspira-ui](https://inspira-ui.com/docs/cn/components) 使用 Nuxt 和 Vue 构建漂亮的网站
...
- [vue-clamp](https://github.com/Justineo/vue-clamp) 文本截断
...
- [vue-sonner](https://github.com/xiaoluoboding/vue-sonner) 🔔 一个适用于 Vue 和 Nuxt 的、具有独特风格的 toast 组件
