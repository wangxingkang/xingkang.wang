...
- [postiz-app](https://github.com/gitroomhq/postiz-app) 开源社媒自动化内容发布平台，支持多平台内容分发与发布工作流编排
...
- [watermark-js-plus](https://github.com/zhensherlock/watermark-js-plus) 浏览器/Node 下的图片水印与文字水印工具，支持生成与移除水印相关场景
